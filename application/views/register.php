...
<form id="user_add" action="<?php echo base_url(); ?>user/save_user" method="post" enctype="multipart/form-data">
<div class="form-group row">
  ...
  <a href="<?php echo base_url(); ?>admin/login_user" class="btn btn-primary" >Login</a>
  </div>
  </form>
<script>
//-------------Image validation---------------
